...
export default async function StatisticsLayout({
  ...
  return (
    <>
      {children}
      <aside className="container prose max-w-full">
          ...
          <div className="md:col-span-2">
            <div className="max-w-prose mx-auto">
              ...
              <p>
                ...
                studieforbundenes kursvirksomhet, medlemsorganisasjoner og bruk
                av statstilskudd. Vi bruker blant annet data fra Statistisk
              ...
              <dl>
                ...
                <dd>
                  ...
                  sammenslått, forsøker vi å korrigere for dette bakover i tid -
                  der dette er mulig. For kommuner som er sammenslått, vil vi
                  slå sammen data om de to kommunene bakover i tid. For kommuner
                  som er delt vil ikke dette være mulig, og det vi i så fall
                  kunne mangle data om kommunen fra de årene den var
                  sammenslått.
                </dd>
              </dl>
            </div>
