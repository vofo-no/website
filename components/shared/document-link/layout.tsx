...
export function DocumentLinkLayout({ data }: Props) {
  ...
  return (
    <Link
      ...
      className="flex gap-4 -mx-4 bg-muted text-muted-foreground border-l-4 border-l-blue-700 my-6 no-underline group items-center"
    >
      <div className="flex flex-col gap-1 shrink overflow-hidden px-4 py-4">
        ...
        <div className="text-sm font-normal leading-normal">{description}</div>
      </div>
      {imageUrl && (
